...
SVC_NAME="actions.runner.emreatadl-atadil-personal-blog.atadil-personal-blog"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (emreatadl-atadil-personal-blog.atadil-personal-blog)"
